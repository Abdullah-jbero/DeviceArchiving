...
namespace DeviceArchiving.WindowsForm.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void SetupUI()
        {
            ...
            var lblGlobalSearch = new Guna2HtmlLabel { Text = "«·»ÕÀ «·⁄«„", Location = new Point(20, 20), AutoSize = true };
            ...
            var lblLaptopName = new Guna2HtmlLabel { Text = "«”„ «··«»  Ê»", Location = new Point(20, 55), AutoSize = true };
            ...
            var lblSerialNumber = new Guna2HtmlLabel { Text = "«·—ﬁ„ «· ”·”·Ì", Location = new Point(320, 55), AutoSize = true };
            ...
            var lblType = new Guna2HtmlLabel { Text = "«·‰Ê⁄", Location = new Point(620, 55), AutoSize = true };
            ...
            var btnAddDevice = new Guna2Button { Text = "≈÷«›… ÃÂ«“", Location = new Point(20, 10), Width = 110, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnEditDevice = new Guna2Button { Text = " ⁄œÌ· ÃÂ«“", Location = new Point(140, 10), Width = 110, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnDeleteDevice = new Guna2Button { Text = "Õ–› ÃÂ«“", Location = new Point(260, 10), Width = 110, BorderRadius = 8, FillColor = Color.FromArgb(230, 57, 70), ForeColor = Color.White };
            var btnExportExcel = new Guna2Button { Text = " ’œÌ—", Location = new Point(380, 10), Width = 110, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnImportExcel = new Guna2Button { Text = "«Œ — „·› Excel", Location = new Point(500, 10), Width = 130, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnAddOperation = new Guna2Button { Text = "≈÷«›… ⁄„·Ì…", Location = new Point(640, 10), Width = 110, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnShowOperations = new Guna2Button { Text = "⁄—÷ «·⁄„·Ì« ", Location = new Point(760, 10), Width = 110, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnRefresh = new Guna2Button { Text = " ÕœÌÀ", Location = new Point(880, 10), Width = 80, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
            var btnShowOperationTypes = new Guna2Button { Text = "⁄—÷ √‰Ê«⁄ «·⁄„·Ì« ", Location = new Point(970, 10), Width = 130, BorderRadius = 8, FillColor = buttonColor, ForeColor = Color.White };
